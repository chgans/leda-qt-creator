...
public:
    FilesSelectionWizardPage(LedaProjectWizardDialog *ledaProjectWizard, QWidget *parent = 0);
...
private:
    ...
    LedaProjectWizardDialog *m_ledaProjectWizardDialog;
