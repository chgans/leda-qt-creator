...
{
    return QLatin1String(Constants::LEDAMIMETYPE);
}
...
ProjectExplorer::Project *Manager::openProject(const QString &fileName, QString *errorString)
{
    ...
    return new LedaProject(this, fileName);
}

void Manager::registerProject(LedaProject *project)
{
    m_projects.append(project);
}

void Manager::unregisterProject(LedaProject *project)
{
