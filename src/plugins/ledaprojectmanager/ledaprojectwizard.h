...
#ifndef LEDAPROJECTWIZARD_H
#define LEDAPROJECTWIZARD_H
...
class LedaProjectWizardDialog : public Core::BaseFileWizard
{
    Q_OBJECT

public:
    explicit LedaProjectWizardDialog(const Core::BaseFileWizardFactory *factory, QWidget *parent = 0);
...
class LedaProjectWizard : public Core::BaseFileWizardFactory
{
    Q_OBJECT
