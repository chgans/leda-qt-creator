...
using namespace LedaProjectManager;
using namespace LedaProjectManager::Internal;
...
{
    const QString fileName(_(SRCDIR "/../../../tests/ledaprojectmanager/") + project);
    return QFileInfo(fileName).absoluteFilePath();
}

} // anonymous namespace

void LedaProjectPlugin::test_simple()
{
...
void LedaProjectPlugin::test_mixed1()
{
    Tests::VerifyCleanCppModelManager verify;
...
void LedaProjectPlugin::test_mixed2()
{
    Tests::VerifyCleanCppModelManager verify;
