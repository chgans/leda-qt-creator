...
//////////////////////////////////////////////////////////////////////////////
//
// LedaProjectWizardDialog
//
//////////////////////////////////////////////////////////////////////////////

LedaProjectWizardDialog::LedaProjectWizardDialog(const Core::BaseFileWizardFactory *factory,
                                                       QWidget *parent) :
...
QString LedaProjectWizardDialog::path() const
{
    return m_firstPage->path();
}

QStringList LedaProjectWizardDialog::selectedPaths() const
{
    return m_secondPage->selectedPaths();
}

QStringList LedaProjectWizardDialog::selectedFiles() const
{
    return m_secondPage->selectedFiles();
}

void LedaProjectWizardDialog::setPath(const QString &path)
{
    m_firstPage->setPath(path);
}

QString LedaProjectWizardDialog::projectName() const
{
...
LedaProjectWizard::LedaProjectWizard()
{
    ...
    setDisplayName(tr("Libray Project"));
    setId("A.Leda");
    setDescription(tr("Creates an integrated library project."));
    setCategory(QLatin1String(Constants::LEDA_PROJECT_WIZARD_CATEGORY));
    setDisplayCategory(QLatin1String(Constants::LEDA_PROJECT_WIZARD_CATEGORY_DISPLAY));
    setFlags(Core::IWizardFactory::PlatformIndependent);
}

Core::BaseFileWizard *LedaProjectWizard::create(QWidget *parent,
                                                   const Core::WizardDialogParameters &parameters) const
{
    LedaProjectWizardDialog *wizard = new LedaProjectWizardDialog(this, parent);
...
Core::GeneratedFiles LedaProjectWizard::generateFiles(const QWizard *w,
                                                         QString *errorMessage) const
{
    Q_UNUSED(errorMessage)

    const LedaProjectWizardDialog *wizard = qobject_cast<const LedaProjectWizardDialog *>(w);
    const QString projectPath = wizard->path();
    const QDir dir(projectPath);
    const QString projectName = wizard->projectName();
    const QString creatorFileName = QFileInfo(dir, projectName + QLatin1String(".leproj")).absoluteFilePath();
...
bool LedaProjectWizard::postGenerateFiles(const QWizard *w, const Core::GeneratedFiles &l,
                                             QString *errorMessage) const
{
    Q_UNUSED(w);
